...
// import { div, div } from '@react-spring/div'
// import './Styling/ExploreADAS.css'
// import bits_logo from './Images/bits_logo.png'
// function ExploreADAS() {
//     return (
...
//                 </ul>
//             </nav>
//             <div pages={3.85} style={{ top: '0', left: '0' }} className="animation">
//                 <div offset={0} speed={1.5} factor={1}>
//                     <div className="animation_layer1 div" id="background" >
//                     </div>
//                 </div>
//                 <div offset={0} speed={0.5} >
//                     <div className="contentblock" >
