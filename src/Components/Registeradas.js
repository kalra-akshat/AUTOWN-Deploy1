                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form">
                            <div className="subform" > <label htmlFor='name'>Name</label>
                                <input className='inparea1' autoComplete='off' name='name' id='name'
                                ...
                                <input className='inparea1' autoComplete='off' name='bitsemail' id='bitsemail'
                                ...
                                <input className='inparea1' autoComplete='off' name='bitsid' id='bitsid'
                                ...
                                <input className='inparea1' autoComplete='off' name='participants' id='participants'
